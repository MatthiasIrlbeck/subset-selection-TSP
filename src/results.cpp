...
void write_memory_plan(std::ostream& out, const MemoryPlan& plan, const std::string& indent) {
    out << indent << "{\n"
        ...
        << indent << "  \"detected_available_bytes\": " << plan.detected_available_bytes << ",\n"
        << indent << "  \"automatic_budget\": "
        << (plan.automatic_budget ? "true" : "false") << ",\n"
        << indent << "  \"fixed_overhead_bytes\": " << plan.fixed_overhead_bytes << ",\n"
        << indent << "  \"estimated_instance_bytes\": " << plan.estimated_instance_bytes << ",\n"
        << indent << "  \"estimated_serialization_bytes\": " << plan.estimated_serialization_bytes << ",\n"
        << indent << "  \"estimated_held_karp_call_bytes\": " << plan.estimated_held_karp_call_bytes << ",\n"
        << indent << "  \"estimated_oracle_call_bytes\": " << plan.estimated_oracle_call_bytes << ",\n"
        << indent << "  \"estimated_control_reference_bytes\": " << plan.estimated_control_reference_bytes << ",\n"
        << indent << "  \"ordinary_phase_peak_bytes\": " << plan.ordinary_phase_peak_bytes << ",\n"
        << indent << "  \"held_karp_phase_peak_bytes\": " << plan.held_karp_phase_peak_bytes << ",\n"
        << indent << "  \"oracle_phase_peak_bytes\": " << plan.oracle_phase_peak_bytes << ",\n"
        << indent << "  \"control_reference_phase_peak_bytes\": " << plan.control_reference_phase_peak_bytes << ",\n"
        ...
        << indent << "  \"held_karp_concurrency\": " << plan.held_karp_concurrency << ",\n"
        << indent << "  \"oracle_concurrency\": " << plan.oracle_concurrency << ",\n"
...
std::string results_to_json(const ResultsDocument& doc) {
    ...
    out << "{\n"
        ...
        << "    \"git_tree\": \"" << json_escape(kGitTree) << "\",\n"
        << "    \"source_dirty\": " << (kSourceDirty ? "true" : "false") << ",\n"
        << "    \"revision_source\": \"" << json_escape(kRevisionSource) << "\",\n"
        << "    \"source_refnames\": \"" << json_escape(kSourceRefNames) << "\",\n"
